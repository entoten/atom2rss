...
```
Teams (RSS アプリ) ──→ arom2rss (Cloudflare Worker) ──→ github.com/*.atom
...
| --- | --- | --- |
| リリース | `https://github.com/OWNER/REPO/releases.atom` | `https://arom2rss.<subdomain>.workers.dev/OWNER/REPO/releases.atom` |
| コミット | `https://github.com/OWNER/REPO/commits/main.atom` | `https://arom2rss.<subdomain>.workers.dev/OWNER/REPO/commits/main.atom` |
| タグ | `https://github.com/OWNER/REPO/tags.atom` | `https://arom2rss.<subdomain>.workers.dev/OWNER/REPO/tags.atom` |
| ユーザーの活動 | `https://github.com/USER.atom` | `https://arom2rss.<subdomain>.workers.dev/USER.atom` |
...
デプロイ後に表示される `https://arom2rss.<あなたのsubdomain>.workers.dev` が公開 URL です。
...
2. RSS フィードの URL に Worker 経由の URL を入力
   例: `https://arom2rss.<subdomain>.workers.dev/cloudflare/workers-sdk/releases.atom`
